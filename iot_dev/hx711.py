...
class Scales(HX711):
    def __init__(self, d_out, pd_sck):
        ...
        self.offset = cfg.hx711_offset #hx711空载读数
        self.rate=cfg.hx711_rate #hx711重量对应读数的斜率值
    ...
    def stable_weight(self, reads=10, delay_us=500): #测量10次，取均值，返回多少g（误差似乎2g以内）
        self.power_on()
        values = []
        ...
        self.power_off()
        print(f"{values=}")
        return sum(values)/len(values)/self.rate
